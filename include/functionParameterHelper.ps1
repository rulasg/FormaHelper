# {"Version":"1.0.0","Date":"2026-07-03","Source":"includehelper","HeaderVersion":1}
...
function ConvertTo-CompleteResults{
    ...
    process{
        ...
        if($wordToComplete.Length -lt $MinWordToCompleteLength){
            "Word to complete '$wordToComplete' is less than $MinWordToCompleteLength characters. Returning empty list." | Write-Mydebug -Section "ArgumentCompleter"
            return @()
        }
